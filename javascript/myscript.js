...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= " Click vào nếu thích nhé Thảo " + (thePercent+1911);
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp; Cho Tính xin quà 20/11 ạ :))';
document.querySelector('.Description .modal-body').innerHTML = 'Không cho cũng không sao :))) <i class="fa-regular fa-face-awesome"></i> ';
